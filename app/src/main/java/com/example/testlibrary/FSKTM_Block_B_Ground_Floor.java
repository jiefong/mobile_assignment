...
public class FSKTM_Block_B_Ground_Floor extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fsktm__block__b__ground__floor);
        ...
        PointF destination = new PointF(2000, 400);
...
//        Dijsktra algo
    ...
    public void goUpstair(View v){
        ...
        PointF destination = new PointF(400, 2000);
        PointF[] array = {start, new PointF(1500, 1500), destination};
        imageView.setPin(start, destination);
        imageView.setRoute(array);
    }
